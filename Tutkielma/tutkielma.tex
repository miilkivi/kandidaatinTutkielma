...
Persoonallisuuden vaikustusta voidaan tutkia erilaisten mallien avulla ja myös yhdistelemällä menetelmiä. Luvussa käsitellään ensin erästä yhdsitelmä mallia tarkemmin. Luvussa tutustutaan myös johtamistyyleihin. Lopulta luodaan katsaus persoonallisuuden piirteisin joiden on huomattu vaikuttavan johtajan toiminataan ja samalla ryhmän toimintaan .
...
Avoimuudella FFM:ssa tarkoitetaan kykyä löytää epätavallisia ideoita, mielikuvituksellisuus, uteliaisuus, emootiot ja seikkailullisuus~\cite{Wang:2009:PMP:1639950.1640049}. 

Neuroottisuus kuvastaa useita negatiivisia piirteitä. Näitä piirteitä ovat esimerkiksi viha, levottomuus ja masentuneisuus. 

Johtajan miellyttävyyteen liitetään piirteitä, jotka rakentava ryhmän jäsenten luottamusta johtajaan. Piirteitä ovat esimerkiksi kiltteys, auttavainen, yhteistyökykyinen ja huomaavaisuus~\cite{Wang:2009:PMP:1639950.1640049}.

FFM:ssä tunnollisuuden tekijällä tarkoitetaan piirteitä kuten itsekuri, velvollisuudentuntoisuus ja tavoitteellisuus. 
