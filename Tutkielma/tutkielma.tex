...
Johtaminen on käsitteenä erittäin laaja ja johtaminen on aina tilanteeseensa sidottua. Tutkimuksissa johtamisesta puhutaan monin eri käsittein ja jokaisen suuntauksen käsitteleminen ei ole tämän tutkielman osalta oleellista. Tässä osassa pyrin selventämään johtamisen käsitteistöä, jonka vaikutusta johtajan persoonallisuuteen tulen tarkastelemaan myöhemmin tutkielmassa. 
