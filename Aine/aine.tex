...
Ketterät menetelmät (agile methodologies) on kokoelma erilaisia kehitys menetelmiä, joiden ideologia perustuu ketterän manifestin ajatuksiin (Tähän tulee agilen viiten kun osaan sen tehdä). Menetelmien tarkoituksena on pyrkiä mahdollisimman hyvään asiakas tyytyväisyyteen. Tämän tavoitteen saavuttamiseksi ohjelmistosta pyritään tarjoamaan asiakkaalle toimiva versio jatkuvasti kehityksen aikana. 

Manifesti os syntynyt vuonna 2001 17 tunnetun ohjelmistoalanammattilaisen tapaamisessa. Ryhmän jäsenten oli tarkoitus löytää yheteinen käsitys uusista menetelmistä, joita oli ohjelmistojen kehitykseen syntynyt. Ketteriksi menetelmiksi voidaan lukea muunmuassa Extreme programing(XP), SCRUM, Crystal  ja Feature-Driven development. Tässä aineessa ketteristä menetelmistä käsitellään tarkemmin johtamista XP ja SCRUM kehyksissä. 
...
XP.... on kehittynyt (kun artsuja :P)

SCRUM... on kehittynyt (kun artsuja :P) 
