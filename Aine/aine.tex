...
Ohjelmisotuotanprojekteissa on tapahtumassa murros perinteisisetä vesiputous mallista kohti uudempia ketteriä mentelmiä~\cite{Chow2008961}. Kehitysprosessin muuttuessa on samalla johtajuus ja johtaminen muuttunut ohjelmistotuotantoprojekteissa. Johtajan rooli on muuttunut ohjelmistotuotanprojekteissa ketterien menetelmien myötä. Ketterissä menetelmissä esimerkiksi scrumissa projektipäälikön nimitys on muutettu scrum masteriksi koska tehtävät ovat muuttuneet ja samalla halutaan korostaa ryhmän itse organisoitumista~\cite{4755768}. 
...
\section{Muutos johtaminen ja riskien hallinta}
