...
Ohjelmisotuotanprojekteissa on tapahtumassa murros perinteisistä malleista kohti uudempia, niin kutsuttuja ketteriä menetelmiä~\cite{Chow2008961}.  Projektimallin muuttuminen on vaikuttanut projekti ryhmän toimintaan. Muutoksilla on myös vaikutusta ohjelmistotuotantoprojektien johtamiseen ja johtajana toimimiseen ohjelmistotuotantoprojekteissa.

Perinteisessä vesiputousmallissa johtaminen on ollut armeija maista~\cite{Nerur:2005:CMA:1060710.1060712}. Jo~\cite{palmer2001emotional}htajan ja alaisen suhde perustuu perinteisissä menetelmissä sopimukseen, jossa alaiselle on määritetty tehtävä ja hän saa korvauksen suoritettuaan tehtävänsä~\cite{thite2000leadership}. Johtajan tehtävänä on ollut kontrolloida, suunnitella ja tarkasella tuotanto prosessin toimivuutta~\cite{palmer2001emotional}. 

Johtaminen on muuttunut viimeisten vuosikymmeninen aikana. Teollisuus on muuttunut enemmän palvelu orientoituneeksi ja samallla johtajana tehtävät ovat muuttuneet. Johtajan tehtäviksi on muodostunut työntekijöiden motivaation kasvattaminen ja inspiraation lisääminen ryhmän keskuudessa~\cite{palmer2001emotional}.  Ohjelmistotuotantoprojekeissa tähän muutokseen on vaikuttanut uusien menetelmien yleistyminen. Ketterissä mentelmissä johtaminen perustuu yhteistyölle ja johtajuudelle~\cite{Nerur:2005:CMA:1060710.1060712}. 
...
\section{Ketterät menetelmät ja johtamisen käsitteistöä}
